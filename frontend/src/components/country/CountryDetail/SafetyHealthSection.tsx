...
const SafetyHealthSection: React.FC<SafetyHealthSectionProps> = ({ selectedCountry }) => {
  return (
    <>
      <div id="safety" className="info-block full-width scroll-mt">
        ...
        {/* Informacja o Odyseuszu przeniesiona tutaj */}
...
export default SafetyHealthSection;
